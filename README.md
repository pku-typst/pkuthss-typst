...
| 用途     | 字体名称                 | 备选方案                                          |
| -------- | ------------------------ | ------------------------------------------------- |
| 中文正文 | 宋体 (SimSun)            | 思源宋体 (Source Han Serif) / Noto Serif CJK SC   |
| 中文标题 | 黑体 (SimHei)            | 思源黑体 (Source Han Sans) / Noto Sans CJK SC     |
...
- **Linux**：安装 `fonts-noto-cjk` 或下载 [思源字体](https://github.com/adobe-fonts/source-han-serif)（宋体、黑体的字体链已内置这些开源字体作为回退）
- **仓库自带**：`fonts/` 目录仅包含开源的 New Computer Modern Mono（代码字体）；商业字体（中易宋体/黑体/楷体/仿宋、Times New Roman、Arial）因版权原因不随仓库分发，详见 `fonts/README.md`
