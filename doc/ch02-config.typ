...
#booktab(
  ...
  [`bib-cn-first`],
  [`true`],
  [仅 `bibstyle: "author-date"`。`true`（默认）时参考文献列表中中文条目排在外文之前；`false` 时外文在前。中文条目按作者姓氏拼音排序（依赖 gb7714-bilingual 与 auto-pinyin）],
  [`bib-pinyin-override`],
  [`(:)`],
  [仅 `author-date` 且中文作者。多音字校正字典，传给 auto-pinyin 的 `override`（音节须为 `tone-num-end` 形式，如 `("重": "chong2")`）。详见 gb7714-bilingual 与 auto-pinyin 文档],
  [`override-bib`],
  [`false`],
